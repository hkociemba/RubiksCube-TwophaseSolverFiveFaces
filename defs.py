...
N_PERM_4 = 24
N_CHOOSE_8_4 = 70
N_MOVE = 15  # number of possible face moves, B1,B2,B3 missing!
...
N_FLIPSLICE_CLASS_2cv = 255664 # number of equivalence classes for combined flip+slice concerning symmetry group C2v(a1)
...
N_CORNERS_CLASS_2cv = 10368  # number of equivalence classes concerning symmetry group C2v(a1)
...
N_SYM_C2v = 4  # Number of symmetries of subgroup C2v(a1)
########################################################################################################################
