...
basicMoveCube = [0] * 5
basicMoveCube[Face.U] = CubieCube(cpU, coU, epU, eoU)
basicMoveCube[Face.R] = CubieCube(cpR, coR, epR, eoR)
basicMoveCube[Face.F] = CubieCube(cpF, coF, epF, eoF)
basicMoveCube[Face.D] = CubieCube(cpD, coD, epD, eoD)
basicMoveCube[Face.L] = CubieCube(cpL, coL, epL, eoL)
########################################################################################################################
